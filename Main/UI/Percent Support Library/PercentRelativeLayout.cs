...
{
	/// <summary>
	/// Subclass of <seealso cref="android.widget.RelativeLayout"/> that supports percentage based dimensions and
	/// margins.
	/// 
	...
	public class PercentRelativeLayout : RelativeLayout
	{
		...
		public PercentRelativeLayout(Context context) : base(context)
		{
		...
		public PercentRelativeLayout(Context context, IAttributeSet attrs) : base(context, attrs)
		{
			if (!InstanceFieldsInitialized)
			{
				InitializeInstanceFields();
		...
		public PercentRelativeLayout(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
		{
			if (!InstanceFieldsInitialized)
			{
				InitializeInstanceFields();
		...
		/*protected override ViewGroup.LayoutParams GenerateDefaultLayoutParams() { return new LayoutParams(ViewGroup.LayoutParams.MatchParent, ViewGroup.LayoutParams.MatchParent); }
		...
		public class LayoutParams : RelativeLayout.LayoutParams, PercentLayoutHelper.PercentLayoutParams
		{
			...
			//public LayoutParams() : this(V.MatchParent, V.MatchParent) {} // custom
			public LayoutParams() : this(V.WrapContent, V.WrapContent) {} // custom
