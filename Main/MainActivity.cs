...
Code: Open source (GPLv2) at: http://github.com/Venryx/Productivity-Tracker".Trim();
				...
				AlertDialog.Builder alert = new AlertDialog.Builder(this);
				alert.SetTitle($"About Productivity Tracker ({PackageManager.GetPackageInfo(PackageName, 0).VersionName})");
				alert.SetMessage("\"Timer-assisted work-and-rest cycle, tracked on a persistent productivity graph.\"");
				alert.SetView(linear);
